...
- **Triagem:** 19 triado(s), 5 incluído(s), 7 em revisão, 7 excluído(s)
- **Elegibilidade:** 12 extração(ões) completa(s), 7 revisão(ões) manual(is), 0 adiada(s)
...
|---|---|---:|---:|---|
| setup | ok | 0.55s | 1 | Verificação do modelo Ollama |
| search | ok | 95.74s | 19 | 19 patentes únicas após dedupe |
| screening | ok | 5.86s | 19 | 5 incluídas, 7 revisão |
| comparative_analysis | ok | 6.63s | 19 | Síntese comparativa gerada |
| whitespace_analysis | ok | 0.00s | 12 | Whitespace analysis estruturada gerada |
| reporting | ok | 0.00s | 19 | Relatórios Markdown e JSON |
...
- **Latência média:** 0.545s
- **Latência máxima:** 0.545s
...
- **Cache hits:** 18
- **Pulos por degradação:** 0
- **Latência média:** 0.079s
- **Latência máxima:** 1.505s
...
- **Cache hits:** 6
- **Pulos por degradação:** 0
- **Latência média:** 0.203s
- **Latência máxima:** 1.419s
...
- **Cache hits:** 11
- **Pulos por degradação:** 0
- **Latência média:** 0.244s
- **Latência máxima:** 2.922s
...
- **Cache hits:** 0
- **Pulos por degradação:** 0
- **Latência média:** 6.626s
- **Latência máxima:** 6.626s
...
- **GooglePatents**: bruto=9, duração=24.97s, diagnósticos=nenhum
- **Patentscope**: bruto=10, duração=70.76s, diagnósticos=nenhum
...
| 8 | [US12401048B1](https://patents.google.com/patent/US12401048B1/en) — Metal-carbon dioxide (CO2) battery cell | 🟡 6.5 (review) | Incremental | Eletroquímica, Baterias |
| 9 | [US20260084089A1](https://patents.google.com/patent/US20260084089A1/en) — Method For Controlling A System For Separating Carbon Dioxid... | 🟡 6.5 (review) | Incremental | Chemical Engineering |
| 10 | [1429678](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135599119&_cid=P12-MQZEES-61776-1) — APPARATUS FOR SUPPLYING LIQUID
CARBON
DIOXIDE | 🟡 6.5 (review) | Significativa | Controle de Processos, Termodinâmica, Sistemas de Refrigeração |
| 11 | [2047588](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135860928&_cid=P12-MQZEES-61776-1) — Reclamation of foundry sand | 🟡 6.5 (review) | Incremental | Materiais de Fundição e Processos Recuperativos |
| 12 | [1125505](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135308953&_cid=P12-MQZEES-61776-1) — Production of
carbon
dioxide
and argon | 🟡 6.5 (review) | Incremental | Chemical Engineering |
| 13 | [1171698](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135354895&_cid=P12-MQZEES-61776-1) — Dispensing Device | 🔴 0.0 (exclude) | N/A | Dispositivos de Dispensação de Líquidos |
| 14 | [1557123](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135726881&_cid=P12-MQZEES-61776-1) — METHOD AND APPARATUS FOR REPARING EXTRACTS OF HOPS AND OTHER... | 🔴 0.0 (exclude) | N/A | Processamento de bebidas alcoólicas |
| 15 | [1426573](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135595668&_cid=P12-MQZEES-61776-1) — WEIGHING MACHINES | 🔴 0.0 (exclude) | N/A | Engenharia de Processos |
| 16 | [1174314](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135357801&_cid=P12-MQZEES-61776-1) — A Dispensing Device for Gases Under Pressure. | 🔴 0.0 (exclude) | N/A | Engenharia de Fluidos, Instrumentação |
| 17 | [1253973](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135438798&_cid=P12-MQZEES-61776-1) — LIQUID MOVING SYSTEMS | 🔴 0.0 (exclude) | N/A | Process Control & Instrumentation |
| 18 | [1329637](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135513929&_cid=P12-MQZEES-61776-1) — TEMPORARY FREEZING OF SOFT OR FLEXIBLE ARTICLES | 🔴 0.0 (exclude) | N/A | Engenharia de Materiais, Refrigeração |
| 19 | [1236064](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135420945&_cid=P12-MQZEES-61776-1) — IMPROVEMENTS IN OR RELATING TO FIRE EXTINGUISHING COMPOSITIO... | 🔴 0.0 (exclude) | N/A | Extinção de Incêndio |
...
### 3. Direct carbon dioxide capture from air
...
### 4. Production of pure carbon dioxide
...
### 8. Method For Controlling A System For Separating Carbon Dioxide From Ambient Air And System

| Campo | Valor |
|-------|-------|
| **Record ID** | `rec_410e383c0a8e` |
| **Family ID** | `family:7ed6cf922fb81b302491e98214bd6b8726374deb` |
| **ID** | `US20260084089A1` |
| **Inventores** | Christian Heimermann, Marcel Wiegel, Peter Kawelke, Martin Hofer, Klaus Behnke, Stephan Weber, Holger Buschmann |
| **Titular** | Volkswagen AG |
| **Data** | 2026-03-26 |
| **Fonte** | Google Patents |
| **URL** | [US20260084089A1](https://patents.google.com/patent/US20260084089A1/en) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
| **Score de Triagem** | 7.2/10 |
...
| **Cluster Temático** | Carbon Dioxide Capture and Separation Technologies |
| **Papel do CO2** | capture_process_stream |
| **Papel do Armazenamento** | explicit_thermal_storage |
| **Limite Sistêmico** | process_integration |
| **Tipo de Ciclo** | adsorption_desorption_cycle |
| **Fonte/Sumidouro Térmico** | ambient_air |
...
**Abstract:**
> AbstractThe disclosure relates to a method for controlling a system for separating carbon dioxide from the ambient air. The method distinguishes between normal operation, in which carbon dioxide is separated from the ambient air, and special operation, which is not primarily used to separate carbon dioxide. Normal operation comprises conveying a stream of air of ambient air into a first process space of the system, wherein the stream of air is dried in the first process space. The dried stream of air of the ambient air is conducted from the first process space into a second process space, in which adsorption and subsequent desorption of carbon dioxide takes place. In the special operation mode, which takes place before or after normal operation, the system is operated with operating parameters that deviate from normal operation.

**Avaliação do LLM:**
Esta patente descreve um método para controlar um sistema de separação de CO2 do ar ambiente, distinguindo entre operações normais e especiais. A operação normal envolve a secagem e adsorção/desorção de CO2, enquanto a operação especial utiliza parâmetros diferentes. O foco principal é na integração de processos para captura e armazenamento de CO2.

**Extração Estruturada:**
- **Problema:** O desafio reside em otimizar o processo de separação de CO2 do ar ambiente, considerando a possibilidade de operações especiais que podem desviar do fluxo normal de operação.
- **Solução:** A patente propõe um método de controle que opera o sistema em duas modalidades: uma operação normal para separação de CO2 e uma operação especial para parâmetros de funcionamento diferentes. Isso permite flexibilidade no processo de captura.
- **Maturidade:** Inicial

**Achados-chave:**
- O sistema utiliza um ciclo de adsorção/desorção para a separação de CO2.
- A patente enfatiza o controle da operação através de ‘parâmetros que se desviam do normal’ na operação especial.

**Vantagens alegadas:**
- Flexibilidade operacional através da operação especial.
- Integração de processos para otimização da captura de CO2.

**Limitações:**
- A patente não detalha especificamente os parâmetros utilizados na ‘operação especial’.
- O foco na integração de processos pode limitar a escalabilidade do sistema.

**Aplicações potenciais:**
- Captura direta de CO2 em fontes industriais.
- Remoção de CO2 da atmosfera (Direct Air Capture).

**Evidências citadas:**
> The method distinguishes between normal operation, in which carbon dioxide is separated...
> The system is operated with operating parameters that deviate from normal operation.

---

### 9. The production of formic acid or formaldehyde from carbon dioxide
...
| **Data** | 24.03.1976 |
| **Fonte** | Patentscope |
| **URL** | [1429678](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135599119&_cid=P12-MQZEES-61776-1) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
| **Score de Triagem** | 7.2/10 |
...
| **Data** | 26.11.1969 |
| **Fonte** | Patentscope |
| **URL** | [1171698](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135354895&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
...
| **Data** | 05.12.1979 |
| **Fonte** | Patentscope |
| **URL** | [1557123](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135726881&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
...
| **Data** | 03.12.1980 |
| **Fonte** | Patentscope |
| **URL** | [2047588](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135860928&_cid=P12-MQZEES-61776-1) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
...
| **Data** | 03.03.1976 |
| **Fonte** | Patentscope |
| **URL** | [1426573](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135595668&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 17.12.1969 |
| **Fonte** | Patentscope |
| **URL** | [1174314](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135357801&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 17.11.1971 |
| **Fonte** | Patentscope |
| **URL** | [1253973](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135438798&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 12.09.1973 |
| **Fonte** | Patentscope |
| **URL** | [1329637](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135513929&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 28.08.1968 |
| **Fonte** | Patentscope |
| **URL** | [1125505](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135308953&_cid=P12-MQZEES-61776-1) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
| **Score de Triagem** | 7.2/10 |
...
| **Data** | 16.06.1971 |
| **Fonte** | Patentscope |
| **URL** | [1236064](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135420945&_cid=P12-MQZEES-61776-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
- rec_410e383c0a8e (US20260084089A1) | rota=manual_review | motivo=Triagem indicou revisão humana. | erro_llm=N/A
...
- 1125505, 1429678, 2047588, US12401048B1, US20260084089A1, US2665972A, US8119091B2 formam a fronteira tecnica: sao casos proximos do problema, mas ainda ambiguos quanto ao papel exato do CO2 no armazenamento ou na funcao arquitetural central [IDs: 1125505, 1429678, 2047588, US12401048B1, US20260084089A1, US2665972A, US8119091B2]
...
## Análise Comparativa de Patentes Relacionadas à Captura de Dióxido de Carbono (CO2)

### 2. Tendências Identificadas

*   **Captura Direta do Ar (DAC):** Uma tendência dominante é o desenvolvimento de sistemas DAC, utilizando sorventes sólidos ou processos eletroquímicos para capturar CO2 diretamente da atmosfera [IDs: US12478916B2, WO2021239747A1, US20230191322A1].
*   **Adsorção com Materiais Derivados de Resíduos:** A utilização de materiais adsorventes derivados de resíduos (como carvão ativado a partir de resíduos de café) como método de captura é uma abordagem promissora [IDs: US12391556B1].
*   **Processos Eletroquímicos:** O uso de processos eletroquímicos para a captura e conversão do CO2 está ganhando destaque, especialmente em combinação com soluções aquosas [IDs: US20240228419A1].
*   **Integração Processual:** Várias patentes enfatizam a integração do processo de captura de CO2 com outros processos industriais para otimizar a eficiência e reduzir custos [IDs: US12478916B2, WO2021239747A1, US20230191322A1].
*   **Utilização do CO2:** Embora menos proeminente, algumas patentes exploram a utilização do CO2 capturado como matéria-prima para a produção de produtos químicos ou materiais [IDs: US20240228419A1].

### 3. Whitespaces e Oportunidades

- O whitespace mais promissor esta na combinacao entre arquiteturas de ciclo/transferencia termica com CO2 e armazenamento explicito do inventario termico, porque esses elementos ainda aparecem fragmentados entre nucleo, fronteira e adjacencia [IDs: US12391556B1, US12478916B2, WO2021239747A1, US20230191322A1]
...
10. **US20260084089A1** — armazenamento termico explicito como parte central; score 6.5/10 [IDs: US20260084089A1]
...
- **Carbon Dioxide Capture and Separation Technologies** [IDs: US20260084089A1]
...
10. **US20260084089A1** — score 6.5/10 [IDs: US20260084089A1]
...
- **hybrid_cycle_storage_architecture**: Combinar ciclos/transferencia com CO2 e armazenamento termico explicitamente reivindicado ainda aparece fragmentado entre nucleo e borda tecnica. [core=US12391556B1, US12478916B2, WO2021239747A1 | frontier=1125505, 1429678, 2047588 | adjacent=N/A]
- **control_and_operability_claims**: Ha espaco para claims de controle, operacao transiente e integracao de processo onde o papel do CO2 e do armazenamento ainda esta ambiguo. [core=US12391556B1, US12478916B2, WO2021239747A1 | frontier=1429678 | adjacent=N/A]
...
- **Data de geração:** 29/06/2026 15:55:53
- **Query de busca:** `carbon dioxide`
- **Status da execução:** completed
- **Tempo total:** 108.8s
- **LLM disponível:** sim
- **Fila de revisão manual:** 7 itens
- **Snapshot hash:** `2498ab757ef765a60545ef4429b114e7aeddcc2d9d54ee1d2fb7e1ca3bd5d981`
...
- **Cache LLM:** 35 hits, 4 misses, 103 entradas
