...
- **Triagem:** 20 triado(s), 5 incluído(s), 8 em revisão, 7 excluído(s)
- **Elegibilidade:** 13 extração(ões) completa(s), 8 revisão(ões) manual(is), 0 adiada(s)
...
|---|---|---:|---:|---|
| setup | ok | 27.84s | 1 | Verificação do modelo Ollama |
| search | ok | 97.17s | 20 | 20 patentes únicas após dedupe |
| screening | ok | 14.55s | 20 | 5 incluídas, 8 revisão |
| comparative_analysis | ok | 6.71s | 20 | Síntese comparativa gerada |
...
- **Latência média:** 27.834s
- **Latência máxima:** 27.834s
...
- **Cache hits:** 18
- **Pulos por degradação:** 0
- **Latência média:** 0.263s
- **Latência máxima:** 3.621s
...
- **Cache hits:** 6
- **Pulos por degradação:** 0
- **Latência média:** 0.39s
- **Latência máxima:** 1.704s
...
- **Cache hits:** 11
- **Pulos por degradação:** 0
- **Latência média:** 0.474s
- **Latência máxima:** 3.125s
...
- **Cache hits:** 0
- **Pulos por degradação:** 0
- **Latência média:** 6.701s
- **Latência máxima:** 6.701s

## 🔎 Observabilidade Estruturada

### Rotas

- **manual_review**: total=8, include=0, review=8, exclude=0, llm_errors=0
- **screen_only**: total=7, include=0, review=0, exclude=7, llm_errors=0
- **deep_extraction**: total=5, include=5, review=0, exclude=0, llm_errors=0

### Fontes

- **EPO**: bruto=0, duração=0.00s, diagnósticos=config_missing=1
- **GooglePatents**: bruto=10, duração=30.91s, diagnósticos=nenhum
- **Patentscope**: bruto=10, duração=66.25s, diagnósticos=nenhum
...
|---|---------|-------|----------|---------|
| 1 | [US12391556B1](https://patents.google.com/patent/US12391556B1/en) — Carbon dioxide capture using activated carbon derived from s... | 🟢 8.1 (include) | Incremental | Química, Engenharia Química, Materiais |
| 2 | [WO2021239747A1](https://patents.google.com/patent/WO2021239747A1/en) — Method for capture of carbon dioxide from ambient air and co... | 🟢 8.1 (include) | Significativa | Engenharia Química / Tecnologias de Captura de Carbono |
...
| 4 | [US20230191322A1](https://patents.google.com/patent/US20230191322A1/en) — Systems and methods for direct air carbon dioxide capture | 🟢 8.0 (include) | Significativa | Engenharia Química / Processamento de Gases |
| 5 | [US20240228419A1](https://patents.google.com/patent/US20240228419A1/en) — The production of formic acid or formaldehyde from carbon di... | 🟢 8.0 (include) | Significativa | Química Industrial |
| 6 | [US8119091B2](https://patents.google.com/patent/US8119091B2/en) — Carbon dioxide capture | 🟡 6.5 (review) | Incremental | Chemical Engineering, Environmental Technology |
...
| 8 | [US12569806B2](https://patents.google.com/patent/US12569806B2/en) — Devices, methods, and systems for capturing and sequestering... | 🟡 6.5 (review) | Incremental | Bioprocessing & Carbon Capture |
...
| 10 | [US8500855B2](https://patents.google.com/patent/US8500855B2/en) — System and method for carbon dioxide capture and sequestrati... | 🟡 6.5 (review) | Incremental | Chemical Engineering |
| 11 | [1429678](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135599119&_cid=P11-MQZEAI-87435-1) — APPARATUS FOR SUPPLYING LIQUID
CARBON
DIOXIDE | 🟡 6.5 (review) | Significativa | Controle de Processos, Termodinâmica, Sistemas de Refrigeração |
| 12 | [2047588](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135860928&_cid=P11-MQZEAI-87435-1) — Reclamation of foundry sand | 🟡 6.5 (review) | Incremental | Materiais de Fundição e Processos Recuperativos |
| 13 | [1125505](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135308953&_cid=P11-MQZEAI-87435-1) — Production of
carbon
dioxide
and argon | 🟡 6.5 (review) | Incremental | Chemical Engineering |
| 14 | [1171698](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135354895&_cid=P11-MQZEAI-87435-1) — Dispensing Device | 🔴 0.0 (exclude) | N/A | Dispositivos de Dispensação de Líquidos |
| 15 | [1557123](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135726881&_cid=P11-MQZEAI-87435-1) — METHOD AND APPARATUS FOR REPARING EXTRACTS OF HOPS AND OTHER... | 🔴 0.0 (exclude) | N/A | Processamento de bebidas alcoólicas |
| 16 | [1174314](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135357801&_cid=P11-MQZEAI-87435-1) — A Dispensing Device for Gases Under Pressure. | 🔴 0.0 (exclude) | N/A | Engenharia de Fluidos, Instrumentação |
| 17 | [1426573](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135595668&_cid=P11-MQZEAI-87435-1) — WEIGHING MACHINES | 🔴 0.0 (exclude) | N/A | Engenharia de Processos |
| 18 | [1253973](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135438798&_cid=P11-MQZEAI-87435-1) — LIQUID MOVING SYSTEMS | 🔴 0.0 (exclude) | N/A | Process Control & Instrumentation |
| 19 | [1329637](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135513929&_cid=P11-MQZEAI-87435-1) — TEMPORARY FREEZING OF SOFT OR FLEXIBLE ARTICLES | 🔴 0.0 (exclude) | N/A | Engenharia de Materiais, Refrigeração |
| 20 | [1236064](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135420945&_cid=P11-MQZEAI-87435-1) — IMPROVEMENTS IN OR RELATING TO FIRE EXTINGUISHING COMPOSITIO... | 🔴 0.0 (exclude) | N/A | Extinção de Incêndio |
...
### 2. Carbon dioxide capture using activated carbon derived from spent coffee grounds
...
### 4. Method for capture of carbon dioxide from ambient air and corresponding adsorber structures with a plurality of parallel surfaces
...
### 5. Devices, methods, and systems for capturing and sequestering atmospheric gases

| Campo | Valor |
|-------|-------|
| **Record ID** | `rec_ae2e0b349f26` |
| **Family ID** | `family:10c1004a1852d5f7e18e91f6ee1bf9880732e8b0` |
| **ID** | `US12569806B2` |
| **Inventores** | Claude Steven McDaniel |
| **Titular** | Like Lichen LLC |
| **Data** | 2026-03-10 |
| **Fonte** | Google Patents |
| **URL** | [US12569806B2](https://patents.google.com/patent/US12569806B2/en) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
...
| **Score de Relevância** | 6.5/10 |
| **Nível de Inovação** | Incremental |
| **Domínio Técnico** | Bioprocessing & Carbon Capture |
| **Cluster Temático** | Sistemas Integrados de Captura e Utilização de CO2 |
| **Papel do CO2** | capture_process_stream |
| **Papel do Armazenamento** | explicit_thermal_storage |
| **Limite Sistêmico** | process_integration |
| **Tipo de Ciclo** | not_clear |
...
**Abstract:**
> AbstractA carbon dioxide capture and sequestration system comprises a growth module, a drying module, a sequestration module and a carbon dioxide recapture apparatus. The carbon dioxide recapture apparatus includes at least one conduit coupled to the growth module, the drying module, and the sequestration module for routing carbon dioxide liberated from at least one of the harvested algal biomass within the drying module and the dried algal biomass withing the sequestration module to the growth module.

**Avaliação do LLM:**
Esta patente descreve um sistema para captura e sequestro de gases atmosféricos, utilizando um módulo de crescimento, um módulo de secagem e um módulo de sequestro, com um dispositivo de recuperação de CO2 que direciona o CO2 liberado da biomassa algal para o módulo de crescimento. O foco principal é a integração do sistema e a captura do CO2 proveniente da biomassa algal.

**Extração Estruturada:**
- **Problema:** Capturar e sequestrar gases atmosféricos, especificamente CO2, de forma eficiente.
- **Solução:** A patente propõe um sistema que utiliza a biomassa algal para capturar o CO2, secando-a e então utilizando-a novamente no processo de crescimento da alga, criando um ciclo fechado.
- **Maturidade:** Inicial

**Achados-chave:**
- O sistema inclui um dispositivo de recuperação de CO2 que conecta os módulos de crescimento, secagem e sequestro.
- A patente foca na integração do sistema para capturar e reutilizar o CO2 liberado pela biomassa algal.

**Vantagens alegadas:**
- Ciclo fechado de captura e utilização de CO2.
- Integração de diferentes etapas do processo (crescimento, secagem e sequestro).

**Limitações:**
- O abstract não detalha o tipo específico de armazenamento térmico utilizado.
- A patente se concentra na arquitetura do sistema, sem abordar especificamente a eficiência da captura ou do armazenamento.

**Aplicações potenciais:**
- Captura e sequestro de CO2 em processos biológicos.
- Desenvolvimento de sistemas de ciclo fechado para produção de biomassa.

**Evidências citadas:**
> “at least one conduit coupled to the growth module, the drying module, and the sequestration module…”

---

### 6. Metal-carbon dioxide (CO2) battery cell
...
### 7. Systems and methods for direct air carbon dioxide capture
...
### 8. The production of formic acid or formaldehyde from carbon dioxide
...
### 9. One-step process for the production of hydrocarbons from carbon dioxide
...
### 10. System and method for carbon dioxide capture and sequestration
...
| **Data** | 24.03.1976 |
| **Fonte** | Patentscope |
| **URL** | [1429678](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135599119&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
| **Score de Triagem** | 7.2/10 |
...
| **Data** | 26.11.1969 |
| **Fonte** | Patentscope |
| **URL** | [1171698](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135354895&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
...
| **Data** | 05.12.1979 |
| **Fonte** | Patentscope |
| **URL** | [1557123](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135726881&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
...
| **Data** | 03.12.1980 |
| **Fonte** | Patentscope |
| **URL** | [2047588](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135860928&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
| **Score de Triagem** | 7.0/10 |
...
| **Data** | 17.12.1969 |
| **Fonte** | Patentscope |
| **URL** | [1174314](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135357801&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 03.03.1976 |
| **Fonte** | Patentscope |
| **URL** | [1426573](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135595668&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 17.11.1971 |
| **Fonte** | Patentscope |
| **URL** | [1253973](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135438798&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 12.09.1973 |
| **Fonte** | Patentscope |
| **URL** | [1329637](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135513929&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
| **Data** | 28.08.1968 |
| **Fonte** | Patentscope |
| **URL** | [1125505](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135308953&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | review |
| **Rota** | manual_review |
| **Motivo da rota** | Triagem indicou revisão humana. |
| **Score de Triagem** | 7.2/10 |
...
| **Data** | 16.06.1971 |
| **Fonte** | Patentscope |
| **URL** | [1236064](https://patentscope.wipo.int/search/en/detail.jsf?docId=GB135420945&_cid=P11-MQZEAI-87435-1) |
| **Triagem** | exclude |
| **Rota** | screen_only |
| **Motivo da rota** | Patente excluída na triagem. |
| **Score de Triagem** | 3.5/10 |
...
- rec_ae2e0b349f26 (US12569806B2) | rota=manual_review | motivo=Triagem indicou revisão humana. | erro_llm=N/A
...
- O conjunto comparativo agrega 13 patente(s) e nao deve ser tratado como bloco homogeneo: ha um nucleo direto, fronteiras tecnicas em revisao e adjacencias uteis apenas para delimitar whitespace [IDs: US12391556B1, US20240059978A1, WO2021239747A1, US20230191322A1, US20240228419A1, 1125505, 1429678, 2047588, US12401048B1, US12569806B2, US2665972A, US8119091B2, US8500855B2]
- O subgrupo mais diretamente alinhado ao núcleo da query é US12391556B1, com foco em armazenamento de CO2, compressão/expansão e controle termodinâmico do meio armazenado [IDs: US12391556B1]
- 1125505, 1429678, 2047588, US12401048B1, US12569806B2, US2665972A, US8119091B2, US8500855B2 formam a fronteira tecnica: sao casos proximos do problema, mas ainda ambiguos quanto ao papel exato do CO2 no armazenamento ou na funcao arquitetural central [IDs: 1125505, 1429678, 2047588, US12401048B1, US12569806B2, US2665972A, US8119091B2, US8500855B2]
...
*   **Conversão do CO2:** Uma tendência clara é a busca por processos para converter o CO2 em produtos químicos valiosos (hidrocarbonetos, ácidos orgânicos), impulsionada pela necessidade de valorizar o CO2 e reduzir sua concentração na atmosfera [IDs: US20240059978A1, US20230191322A1, US20240228419A1].
*   **Captura Direta da Atmosfera:** A captura direta do CO2 da atmosfera (DAC) continua sendo uma área de pesquisa ativa, com foco em tecnologias como adsorção e eletroquímica [IDs: WO2021239747A1, US20230191322A1].
*   **Integração de Processos:** A integração do CO2 em processos industriais existentes (eletrolise, produção de produtos químicos) é uma estratégia chave [IDs: US20240059978A1, US20240228419A1].
*   **Materiais Adsorventes:** O desenvolvimento de materiais adsorventes eficientes e econômicos para a captura do CO2 é um foco constante [IDs: US12391556B1, WO2021239747A1].
*   **Fluxo de CO2 como Fluido de Trabalho:** O uso do CO2 como fluido de trabalho em sistemas eletroquímicos e baterias está emergindo como uma abordagem promissora [IDs: US12401048B1].

### 3. Whitespaces e Oportunidades

- O whitespace mais promissor esta na combinacao entre arquiteturas de ciclo/transferencia termica com CO2 e armazenamento explicito do inventario termico, porque esses elementos ainda aparecem fragmentados entre nucleo, fronteira e adjacencia [IDs: US12391556B1, US20240059978A1, WO2021239747A1, US20230191322A1]
- Gestao termica transiente, subresfriamento e acoplamentos com captura/reatores aparecem de forma lateral; isso sugere oportunidade em claims de controle, operacao multi-regime e integracao de processo ainda pouco amarradas ao armazenamento central [IDs: 1125505, US12391556B1, US20240059978A1, WO2021239747A1]
...
1. **US12391556B1** — armazenamento termico explicito como parte central; score 8.1/10 [IDs: US12391556B1]
2. **US20240059978A1** — armazenamento termico explicito como parte central; score 8.1/10 [IDs: US20240059978A1]
3. **WO2021239747A1** — armazenamento termico explicito como parte central; score 8.1/10 [IDs: WO2021239747A1]
4. **US20230191322A1** — armazenamento termico explicito como parte central; score 8.0/10 [IDs: US20230191322A1]
5. **US20240228419A1** — armazenamento termico explicito como parte central; score 8.0/10 [IDs: US20240228419A1]
6. **1125505** — armazenamento termico explicito como parte central; ênfase em refrigeração/sub-resfriamento, mais adjacente ao núcleo da query; score 6.5/10 [IDs: 1125505]
7. **1429678** — CO2 aparece principalmente como fluido de trabalho; armazenamento termico explicito como parte central; score 6.5/10 [IDs: 1429678]
8. **2047588** — armazenamento termico explicito como parte central; score 6.5/10 [IDs: 2047588]
9. **US12401048B1** — CO2 aparece principalmente como fluido de trabalho; armazenamento aparece mais como subsistema de apoio; score 6.5/10 [IDs: US12401048B1]
10. **US12569806B2** — armazenamento termico explicito como parte central; score 6.5/10 [IDs: US12569806B2]
...
13. **US8500855B2** — armazenamento aparece mais como subsistema de apoio; score 6.5/10 [IDs: US8500855B2]
...
- **Sistemas Integrados de Captura e Utilização de CO2** [IDs: US12569806B2]
- **Sistemas de Controle Automatizado para Manipulação de Fluidos Refrigerados** [IDs: 1429678]

### 7. Ranking por ID

1. **US12391556B1** — score 8.1/10 [IDs: US12391556B1]
2. **US20240059978A1** — score 8.1/10 [IDs: US20240059978A1]
3. **WO2021239747A1** — score 8.1/10 [IDs: WO2021239747A1]
4. **US20230191322A1** — score 8.0/10 [IDs: US20230191322A1]
5. **US20240228419A1** — score 8.0/10 [IDs: US20240228419A1]
6. **1125505** — score 6.5/10 [IDs: 1125505]
7. **1429678** — score 6.5/10 [IDs: 1429678]
8. **2047588** — score 6.5/10 [IDs: 2047588]
9. **US12401048B1** — score 6.5/10 [IDs: US12401048B1]
10. **US12569806B2** — score 6.5/10 [IDs: US12569806B2]
11. **US2665972A** — score 6.5/10 [IDs: US2665972A]
12. **US8119091B2** — score 6.5/10 [IDs: US8119091B2]
13. **US8500855B2** — score 6.5/10 [IDs: US8500855B2]
...
- **hybrid_cycle_storage_architecture**: Combinar ciclos/transferencia com CO2 e armazenamento termico explicitamente reivindicado ainda aparece fragmentado entre nucleo e borda tecnica. [core=US12391556B1, US20240059978A1, WO2021239747A1 | frontier=1125505, 1429678, 2047588 | adjacent=N/A]
- **control_and_operability_claims**: Ha espaco para claims de controle, operacao transiente e integracao de processo onde o papel do CO2 e do armazenamento ainda esta ambiguo. [core=US12391556B1, US20240059978A1, WO2021239747A1 | frontier=1429678 | adjacent=N/A]
...
- **Data de geração:** 29/06/2026 15:52:38
- **Query de busca:** `carbon dioxide`
- **Status da execução:** completed
- **Tempo total:** 146.3s
- **LLM disponível:** sim
- **Fila de revisão manual:** 8 itens
- **Snapshot hash:** `97b0e1a5f5625696aaeed6cb59fd74adcf0b8c59a6bfb0b9bf66f74ed9bf7592`
...
- **Cache LLM:** 35 hits, 7 misses, 99 entradas
